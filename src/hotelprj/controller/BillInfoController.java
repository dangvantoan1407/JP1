...
import hotelprj.model.Reservation;
...
public class BillInfoController implements Initializable {
    ...
    public TextField customerIDNumber;
            ...
            try{
              Connection connection = Connector.getInstance().getConnection();
               PreparedStatement pts = connection.prepareStatement(query);
                pts.setString(1, Integer.toString(selectedResID));
    ...
    public void handlePrintAction(ActionEvent actionEvent) throws Exception {
        String id = "";
...
//    private void createBill(String id) throws Exception {
//        String billID = "";
//        String customerName = "";
